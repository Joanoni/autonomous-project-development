...
INPUT_FILE = TOOL_DIR / "input.json"

def load_input() -> dict:
    """Load input.json from the tool directory. Returns empty dict on failure."""
...
def main() -> None:
    ...
    if choice == '2':
        ...
        print(f"\n[1/5] Cloning remote repository into: {root}")
        ...
        print(f"\n[1/5] Creating local directory: {root}")
        root.mkdir(parents=True, exist_ok=True)
    
    # Step 2: Copy Framework Skeleton
    print("[2/5] Copying framework skeleton...")
    ...
    print("[3/5] Generating config.json...")
    ...
    cycle_dir = root / "agent_framework/registry/internal/workspace/tools/internal/cycle"
    print("[4/5] Syncing registry (agents, workspace, roo environment)...")
